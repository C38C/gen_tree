...
lib.gen_hemisphere(vertices_count=20000, gap_percentage=0.136, width=5.0)

#To generate a truncated prolate ellipsoid tree crown. Use this shape when the crown's height > radius
lib.gen_ellipsoid_prolate(vertices_count=20000, gap_percentage=0.059, height=7.8, radius=5.35)

#To generate a truncated oblate ellipsoid tree crown. Use this shape when the crown's height < radius
lib.gen_ellipsoid_oblate(vertices_count=20000, gap_percentage=0.07, height=8.0, radius=10.0)

#To generate a conical tree crown. Use this shape when the tree crown is broad at the base and narrows to the top.
lib.get_cone(vertices_count=10000, gap_percentage=0.18, height=8.5, radius=2.5)
